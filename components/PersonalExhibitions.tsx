import { personalExhibitions } from "@/data/projectsData";
...
const PersonalExhibitions = ({ language }: any) => {
  const lang = language === "EN";

  const personal = personalExhibitions.map(
    ({ date, descriptionPL, descriptionEN, id }: any) => {
      return (
        <div
          key={id}
          id={id}
...
export default PersonalExhibitions;
